...
/**
 * Created by HSEQ on 09/05/2017.
 */
@RestController
@RequestMapping(value="/app/documento")
    ...
    public ResponseEntity<?> InsertarImagen(@PathVariable Integer idContratista, @PathVariable Integer idRequisitoSugerido
        ...
        try {
            ...
            while(itr.hasNext()) {
                ...
                Documento docForDB=new Documento(idContratista,fileForDB,idRequisitoSugerido);
                manejoDeContratistasBD.registrarDocumento(docForDB);
            }
