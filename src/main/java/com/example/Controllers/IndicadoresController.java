...
public class IndicadoresController {
    ...
    @RequestMapping(value = "indicadoresPorMes/{idContratista}/{mes}", method = RequestMethod.GET)
    public ResponseEntity<?>indicadoresPorContratistaMes(@PathVariable int idContratista, @PathVariable String mes){

        ResponseEntity a;
        try {
            //obtener datos que se enviarán a través del API
            a = new ResponseEntity<>(manejadorDeIndicadores.indicadoresPorContratistaMes(idContratista,mes),HttpStatus.ACCEPTED);
