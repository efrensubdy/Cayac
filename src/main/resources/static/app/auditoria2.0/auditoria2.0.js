...
.controller('auditoria2.0Ctrl', ['$http','$location', '$q', '$scope','$mdDialog','$rootScope','$localStorage','$sessionStorage','$window','$route','example','exam','auditoriaContratis','noConformidad','noPorContra','causa','caPorContra','registroDeAccion','accionContra','actualizarNoConformidad','actualizarCausa','actualizarAccion','fileUpload','accionConRegistro','accionSinRegistro','noPorContraAuditoria','noConforCerradasConAuditoria',function($http,$location, $mdDialog, $scope,$log,$rootScope,$localStorage,$sessionStorage,$window,$route,example,exam,auditoriaContratis,noConformidad,noPorContra,causa,caPorContra,registroDeAccion,accionContra,actualizarNoConformidad,actualizarCausa,actualizarAccion,fileUpload,accionConRegistro,accionSinRegistro,noPorContraAuditoria,noConforCerradasConAuditoria) {
