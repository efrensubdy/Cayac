        ...
        $scope.add=function(ev,contrato){
         ...
         function DialogController($scope, $mdDialog, $rootScope, $http) {
          ...
          var q=function(idContratista,idRequisitoSugerido){
                       //var url= "http://localhost:8081/app/imagenes/"+idContratista+"/"+idRequisitoSugerido ;
                       var url= "http://ec2-35-163-21-208.us-west-2.compute.amazonaws.com:8081/app/imagenes/"+idContratista+"/"+idRequisitoSugerido ;
